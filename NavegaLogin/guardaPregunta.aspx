<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="guardaPregunta.aspx.cs" Inherits="NavegaLogin.guardaPregunta" %>
            ...
            <tr>
                ...
                <td class="style5">
                    <asp:Label ID="Label1" runat="server" 
                        Text="No cuentas con Pregunta secreta, debes crearla!" ForeColor="Red"></asp:Label>
                    </td>
            </tr>
            <tr>
                <td class="style2">
        ...
        <asp:Label ID="lblUsuario" runat="server" Text="Usuario:"  ForeColor="Navy" 
                ...
                <td class="style3">
                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="textbox" Width="151px" 
                        Height="24px" Enabled="False" ReadOnly="True"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txtUsuario" 
                        ErrorMessage="El campo usuario es obligatorio"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style2">
        ...
        <asp:TextBox ID="txtRespuesta" runat="server" CssClass="textbox" Width="253px" 
            ...
            <tr>
                ...
                <td class="style7">
                    &nbsp;</td>
                <td class="style3">
        <asp:Button ID="btnGuardar" runat="server" Text="Guardar Pregunta" CssClass="button"
             Width="172px" onclick="btnGuardar_Click" />
